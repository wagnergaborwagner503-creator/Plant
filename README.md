...
- **📦 Kertészeti leltár** (Beállítások → Otthonom és felszerelésem → Kertészeti leltár) — vezesd, milyen cserepeid (**átmérő × magasság**, darabszám), földjeid (hány liter), kaspóid, eszközeid, tápoldataid vannak. Új növénynél / **átültetésnél** kiválaszthatod a cserepet és a földet a leltárból: az app **levonja a felhasznált cserepet és földet**, átültetéskor pedig a **régi cserepet visszateszi** a leltárba. A jelenlegi növények cserepei egy gombbal felvehetők (utólag módosíthatók).
