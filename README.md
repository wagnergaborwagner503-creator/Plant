...
- **📖 Tudástár** (Beállítások → Tudástár) — kereshető, kategóriánként szűrhető növény-enciklopédia (~300+ faj, köztük az Ananász és a húsevő Vénusz légycsapója). Minden faj kártyáján megjelenik a faj-specifikus kulcstanács is (🌱). A gyakori fajok pontos, a többi típus szerinti gondozási adattal. Bővíthető az `index.html`-ben (`PLANT_DB_EXTRA_INLINE` tömb).
